...
#
# train_model()
# unknownimage = cv2.imread(r"C:\Users\ravi9\OneDrive\Pictures\Mero cropped (2).jpg")
# Image_notResized = unknownimage.copy()
# Image_notResized = cv2.resize(Image_notResized, (400,450))
# unknownimage = cv2.resize(unknownimage, (224,224))
#
# cropped_unknownimage,x_start, y_start,height,width = detect_and_crop(unknownimage)
#
...
#     if dist <0.9:
#
#         img,x_start,y_start,width,height = draw_rectangle(Image_notResized, x_start, y_start, height, width)
#
#         cv2.putText(img,known_names[index],(x_start,y_start-5),cv2.FONT_HERSHEY_SIMPLEX,0.7,(0,0,255),2)
#
#         cv2.imshow("face", img)
#         cv2.waitKey(0)
